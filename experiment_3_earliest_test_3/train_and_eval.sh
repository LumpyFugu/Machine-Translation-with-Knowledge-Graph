...
USER_DIR="/home/etlpro/XIXI/experiment/experiment_3_earliest_test_3/src"
DATA=/home/etlpro/XIXI/data/data-bin
SAVE=/home/etlpro/XIXI/experiment/experiment_3_earliest_test_3/log
SRC=ja
TGT=zh
...
############################
EXP="/home/etlpro/XIXI/experiment/experiment_3_earliest_test_3"
...
#RUN_DIR="$SAVE/run_20260103_222637"
mkdir -p "$RUN_DIR"
TB="$RUN_DIR/tb"
...
########################
python /home/etlpro/XIXI/experiment/experiment_3_earliest_test_3/cli/generate_mode1.py "$DATA" \
  --user-dir "$USER_DIR" \
  --task entity_translation \
  --mode 1 \
