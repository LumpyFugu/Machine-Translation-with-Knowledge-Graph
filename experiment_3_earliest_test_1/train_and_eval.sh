...
USER_DIR="/home/etlpro/XIXI/xyc.1/experiment_3_earliest_test_1/src"
DATA=/home/etlpro/XIXI/xyc.1/data-bin
SAVE=/home/etlpro/XIXI/xyc.1/experiment_3_earliest_test_1/log
OUTDIR=/home/etlpro/XIXI/xyc.1/experiment_3_earliest_test_1/result_1
SRC=ja
TGT=zh
...
############################
EXP="/home/etlpro/XIXI/xyc.1/experiment_3_earliest_test_1"
...
d = Dictionary.load("/home/etlpro/XIXI/xyc.1/data-bin/dict.zh.txt")
...
python -m fairseq_cli.train "$DATA" \
  ...
  --max-epoch 20 \
  --patience 5 \
  --ne-dict /home/etlpro/XIXI/xyc.1/data-bin/dict.ne.txt \
  --kg-embed-path /home/etlpro/XIXI/xyc.1/resources/kg_embed.ja.wiki2vec.pt \
  --kg-embed-dim 300 \
  --seed 43 \
...
########################
python /home/etlpro/XIXI/xyc.1/entity_nmt/cli/generate_mode1.py "$DATA" \
  --user-dir "$USER_DIR" \
  --task entity_translation \
  --mode 1 \
...
CUDA_VISIBLE_DEVICES="" /home/etlpro/miniconda3/envs/dp-old/bin/python \
  /home/etlpro/XIXI/xyc.1/entity_nmt/experiment_1/eval_f1.py \
  --sys "$RUN_DIR/sys.$TGT" \
  --ref "$RUN_DIR/ref.$TGT" \
