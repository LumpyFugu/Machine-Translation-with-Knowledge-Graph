...
USER_DIR="/home/etlpro/XIXI/experiment/experiment_5_earliest_test/src"
DATA=/home/etlpro/XIXI/data/data-bin
SAVE=/home/etlpro/XIXI/experiment/experiment_5_earliest_test/log
SRC=ja
TGT=zh
...
############################
EXP="/home/etlpro/XIXI/experiment/experiment_5_earliest_test"
...
#RUN_DIR="$SAVE/run_20260103_222702"
mkdir -p "$RUN_DIR"
TB="$RUN_DIR/tb"
...
########################
python /home/etlpro/XIXI/experiment/experiment_5_earliest_test/cli/generate_mode1.py "$DATA" \
  --user-dir "$USER_DIR" \
  --task entity_translation \
  --mode 1 \
